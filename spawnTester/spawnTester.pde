...
void setup() {
    ...
    gameMap = new GameMap("gaming.mp3", "patterns.json", new PVector(width, height), new RNG(), 1.0);
    println(String.format("Map generation took %ss", (millis() - startMillis) / 1000.0));
...
void draw() {
    ...
    stroke(255);
    noFill();
    circle(width / 2, height / 2, GAME_MARGIN_SIZE);
